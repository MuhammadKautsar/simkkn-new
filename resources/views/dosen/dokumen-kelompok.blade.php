										...
										<div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
											<div class="card" id="kt_chat_messenger">
												...
												<div class="card-body" id="kt_chat_messenger_body">
                                                    <span>1. Batas Unggah Proposal Program Kegiatan Kelompok dari tanggal - sampai tanggal -</span><br>
                                                    <span>2. Batas Upload Logbook Minggu ke-1 dari tanggal - sampai tanggal -</span><br>
                                                    <span>3. Batas Upload Logbook Minggu ke-2 dari tanggal - sampai tanggal -</span><br>
                                                    <span>4. Batas Upload Logbook Minggu ke-3 dari tanggal - sampai tanggal -</span><br>
                                                    <span>5. Batas Upload Logbook Minggu ke-4 dari tanggal - sampai tanggal -</span><br>
                                                    <span>6. Batas Unggah Laporan Akhir Program Kegiatan Kelompok dari tanggal - sampai tanggal -</span><br>
												</div>
												<!--end::Card body-->
												<!--begin::Card footer-->
												<div class="card-footer pt-4" id="kt_chat_messenger_footer">
														<!--begin::Send-->
														<a href="{" class="btn btn-primary" target="blank">Proposal Belum Diupload</a>
														<!--end::Send-->
													<!--end::Toolbar-->
												</div>
												<!--end::Card footer-->
