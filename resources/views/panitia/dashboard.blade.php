    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('kkn.create') }}" class="btn btn-sm fw-bold btn-primary">Create</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        <thead>
                            <tr>
                                <th class="text-center text-xs font-weight-semibold opacity-7">Nama / Periode</th>
                                <th class="text-center text-xs font-weight-semibold opacity-7 ps-2">Jenis</th>
                                <th class="text-center text-xs font-weight-semibold opacity-7 ps-2">Lokasi</th>
                                <th class="text-center text-xs font-weight-semibold opacity-7 ps-2">Masa Kegiatan</th>
                                <th class="text-center text-xs font-weight-semibold opacity-7 ps-2">Status</th>
                                <th class="text-center text-xs font-weight-semibold opacity-7 ps-2">Aksi</th>
                            </tr>
                        </thead>
