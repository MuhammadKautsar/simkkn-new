										...
										<div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
											<div class="card" id="kt_chat_messenger">
                                                ...
                                                <div class="card-body" id="kt_chat_messenger_body">
                                                    <span>1. Batas Unggah Nilai dari tanggal - sampai tanggal -</span><br>
                                                    <span>2. Memasukkan nilai dari DPL dan nilai dari geuchik gampong untuk setiap mahasiswa/mahasiswi pada kelompok tersebut</span><br>
                                                    <span>3. Melampirkan dokumen bukti nilai untuk untuk setiap mahasiswa/mahasiswi pada kelompok tersebut yang disatukan dalam 1 dokumen</span><br>
                                                    <span>4. Maksimum ukuran file sebesar 10MB dengan format .pdf</span><br>
												</div>
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <thead class="bg-gray-100">
                                                            <tr>
                                                                ...
                                                                <th class="text-center min-w-125px">Nama Mahasiswa</th>
                                                                <th class="text-center min-w-125px">Fakultas / Prodi</th>
                                                                <th class="text-center min-w-125px">Nilai Geuchik</th>
                                                                <th class="text-center min-w-125px">Nilai Akhir</th>
                                                            </tr>
                                                        </thead>
                                                        <!--end::Table head-->
                                                        <!--begin::Table body-->
