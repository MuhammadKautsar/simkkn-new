													...
													<div class="scroll-y me-n5 pe-5 h-200px h-lg-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_app_header, #kt_toolbar, #kt_app_toolbar, #kt_footer, #kt_app_footer, #kt_chat_contacts_header" data-kt-scroll-wrappers="#kt_content, #kt_app_content, #kt_chat_contacts_body" data-kt-scroll-offset="5px">
														...
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Details-->
																<div class="ms-5">
																	<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Data Kelompok</a>
																</div>
																<!--end::Details-->
															</div>
															<!--end::Details-->
														...
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Details-->
																<div class="ms-5">
																	<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Unggah Profil Desa</a>
																</div>
																<!--end::Details-->
															</div>
															<!--end::Details-->
														...
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Details-->
																<div class="ms-5">
																	<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Unggah Laporan Survey Lapangan</a>
																</div>
																<!--end::Details-->
															</div>
															<!--end::Details-->
														...
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Details-->
																<div class="ms-5">
																	<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Unggah Laporan Monev</a>
																</div>
																<!--end::Details-->
															</div>
															<!--end::Details-->
														...
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Details-->
																<div class="ms-5">
																	<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Dokumen Anggota Kelompok</a>
																</div>
																<!--end::Details-->
															</div>
															<!--end::Details-->
														...
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Details-->
																<div class="ms-5">
																	<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Unggah Nilai</a>
																</div>
																<!--end::Details-->
															</div>
															<!--end::Details-->
										...
										<div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
											<div class="card" id="kt_chat_messenger">
												...
												<div class="card-footer pt-4" id="kt_chat_messenger_footer">
														<!--begin::Send-->
														<a href="" class="btn btn-primary">Atur Ketua Kelompok</a>
														<!--end::Send-->
													<!--end::Toolbar-->
												</div>
												<!--end::Card footer-->
