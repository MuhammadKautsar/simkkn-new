												...
												<div class="card-header" id="kt_chat_messenger_header">
													...
													<div class="card-title">
														...
														<div class="d-flex justify-content-center flex-column me-3">
															<a href="#" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">Nilai Akhir KKN Periode XXV</a>
														</div>
														<!--end::User-->
													</div>
													<!--end::Title-->
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <thead class="bg-gray-100">
                                                            <tr>
                                                                ...
                                                                <th class="text-center min-w-125px">Predikat Nilai</th>
                                                            </tr>
                                                        </thead>
                                                        <!--end::Table head-->
                                                        <!--begin::Table body-->
